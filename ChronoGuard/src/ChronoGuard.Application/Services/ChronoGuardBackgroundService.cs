...
public class ChronoGuardBackgroundService : BackgroundService
{
        ...
        ISolarCalculatorService solarCalculator)
    {
        ...
        _logger = NullLogger<ChronoGuardBackgroundService>.Instance;
    ...
    public async Task InitializePredictiveCacheAsync(Location location, ColorProfile profile)
    {
        ...
        catch (Exception ex)
        {
            ...
            {
                _logger.LogWarning(ex, "Predictive cache init failed, retrying once");
                _consecutiveErrors++;
            ...
            {
                _consecutiveErrors = 0;
                _logger.LogError(ex, "Predictive cache init failed twice");
                throw;
            }
        }
    }
